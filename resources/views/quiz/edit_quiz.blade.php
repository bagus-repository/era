        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="spinner-form" action="{{ route('quizzes.update', $quiz) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            @include('control.select', [
                                ...
                                'optVal' => 'id',
                                'optDesc' => ['id', 'name'],
                                'select_value' => $quiz->user->id,
                                'required' => 1,
                            ])
                        </div>
                        <div class="form-group">
                            <label for="">Tanggal Quiz <span class="required-label">*</span></label>
                            <input type="text" class="form-control datepicker" name="batch_date" value="{{ $quiz->batch_date }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="subject" value="{{ $quiz->subject }}" required>
                        </div>
                        <div class="form-group">
                            <label for="">Deskripsi <span class="required-label">*</span></label>
                            <textarea name="desc" class="form-control html-editor" rows="3">{!! $quiz->desc !!}</textarea>
                        </div>
                        <div class="form-group">
